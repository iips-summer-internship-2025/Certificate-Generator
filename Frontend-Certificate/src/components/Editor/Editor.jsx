...
//   const csvFile = state?.csvFile;
//   const [showRulesModal, setShowRulesModal] = useState(true); // Changed to true by default
//   const hodSignature = state?.hodSignature;
//   const clubCoordinatorSignature = state?.clubCoordinatorSignature;
//   const clubHeadSignature = state?.clubHeadSignature;
//   const clubSignature = state?.clubSignature;
...
//   const handleSignatureDrop = (e, signatureType) => {
//     e.preventDefault();
//     const rect = imageRef.current.getBoundingClientRect();
//     const x = e.clientX - rect.left;
//     const y = e.clientY - rect.top;
...
//         hod: {
//           x: (signaturePositions.hod.x / imageRef.current.offsetWidth) * 100,
//           y: (signaturePositions.hod.y / imageRef.current.offsetHeight) * 100
//         },
//         coordinator: {
//           x: (signaturePositions.coordinator.x / imageRef.current.offsetWidth) * 100,
//           y: (signaturePositions.coordinator.y / imageRef.current.offsetHeight) * 100
//         },
//         head: {
//           x: (signaturePositions.head.x / imageRef.current.offsetWidth) * 100,
//           y: (signaturePositions.head.y / imageRef.current.offsetHeight) * 100
//         },
//         club: {
//           x: (signaturePositions.club.x / imageRef.current.offsetWidth) * 100,
//           y: (signaturePositions.club.y / imageRef.current.offsetHeight) * 100
//         }
//       }));

//       // Add signature files
//       if (hodSignature) formData.append('hod_signature', hodSignature);
//       if (clubCoordinatorSignature) formData.append('coordinator_signature', clubCoordinatorSignature);
//       if (clubHeadSignature) formData.append('head_signature', clubHeadSignature);
//       if (clubSignature) formData.append('club_signature', clubSignature);
...
//   {/* Signature Images - Should be placed HERE, inside this container */}
//   {hodSignature && (
//     <img
//       src={URL.createObjectURL(hodSignature)}
//       alt="HOD Signature"
//       style={{
//         position: 'absolute',
...
//       onDragOver={(e) => e.preventDefault()}
//       onDrop={(e) => handleSignatureDrop(e, 'hod')}
//     />
//   )}

//   {clubCoordinatorSignature && (
//     <img
//       src={URL.createObjectURL(clubCoordinatorSignature)}
...
//       }}
//       draggable
//       onDragStart={(e) => e.dataTransfer.setData("text/plain", "coordinatorSignature")}
//       onDragOver={(e) => e.preventDefault()}
//       onDrop={(e) => handleSignatureDrop(e, 'coordinator')}
//     />
//   )}

//   {clubHeadSignature && (
//     <img
//       src={URL.createObjectURL(clubHeadSignature)}
//       alt="Head Signature"
//       style={{
//         position: 'absolute',
...
//       }}
//       draggable
//       onDragStart={(e) => e.dataTransfer.setData("text/plain", "headSignature")}
//       onDragOver={(e) => e.preventDefault()}
//       onDrop={(e) => handleSignatureDrop(e, 'head')}
//     />
//   )}

//   {clubSignature && (
//     <img
//       src={URL.createObjectURL(clubSignature)}
//       alt="Club Signature"
//       style={{
//         position: 'absolute',
...
//       onDragOver={(e) => e.preventDefault()}
//       onDrop={(e) => handleSignatureDrop(e, 'club')}
//     />
//   )}
...
//                   maxWidth: '150px',
//                   maxHeight: '50px',
//                   pointerEvents: 'auto' // Changed to make draggable
//                 }}
//                 draggable
//                 onDragStart={(e) => e.dataTransfer.setData("text/plain", "hodSignature")}
//                 onDragOver={(e) => e.preventDefault()}
...
//     // Check if this is a signature drop
//     if (variable.includes('Signature')) {
//       return; // Signature drops are handled separately
//     }
...
//             {/* Main certificate container with drag-and-drop area */}
//             <div
//               className="relative flex items-center justify-center min-h-[80vh] bg-transparent"
//               style={{ display: previewOpen ? "none" : "flex" }}
//               onDrop={handleDrop}
...
//               {droppedVariables.map((item) => (
//                 <div
//                   key={`dropped-${item.name}`}
//                   id={`dropped-${item.name}`}
//                   style={{
//                     position: 'absolute',
//                     left: `${item.x}px`,
//                     top: `${item.y}px`,
