...
export default function Editor() {
  ...
  }, [hodSignature, clubCoordinatorSignature, clubHeadSignature, clubSignature]);
        ...
        <div className="row">
          <div className="col-lg-3 Side_Nav_Bar h-screen">
            ...
            <div className="h-1/2">
              ...
              {/* Signatures Section */}
              <div className="Editor_heading text-center mt-4">
                <div className="Ediotr_svg_parent text-center">
                  <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 24 24" fill="none">
                      <path d="M8 16L16 8M8 8L16 16" stroke="#000000" strokeWidth="2" strokeLinecap="round"/>
                    </svg>
                  </div>
                  <p>Signatures</p>
                </div>
