...
//           {/* Email Field */}
//           <div className="flex items-center gap-3 w-full">
//             <label className="text-sm font-medium text-gray-700 w-1/3 text-right">Email</label>
//             <div className="w-2/3">
//               <input
//                 type="email"
//                 name="email"
...
//           {/* cofirm Password */}
//           <div className="flex items-center gap-3 w-full">
//             <label className="text-sm font-medium text-gray-700 w-1/3 text-right">Cofirm Password</label>
//             <div className="relative w-2/3">
//               <input
//                 type={showPasswords.confirmPassword ? 'text' : 'password'}
//                 name="confirmPassword"
