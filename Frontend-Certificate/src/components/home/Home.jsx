    ...
    <>
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <div className="hero-image">
              <div className="certificate-3d" ref={certificateRef}>
                <img src={template_image} alt="Certificate Template" className="floating" />
      ...
      <section className="how-it-works">
        <div className="container">
          <div className="section-header">
            <h2>How It Works</h2>
            <p className="section-subtitle">Create beautiful certificates in just 3 simple steps</p>
          </div>
          ...
          <div className="cards-container">
            ...
            >
              ...
              <h3>Upload Data</h3>
              <p>Upload your Excel spreadsheet containing recipient information and certificate template.</p>
            ...
            >
              ...
              <p>Customize your template and adjust text, position, colors to create the perfect layout.</p>
        ...
        <div className="container">
          <div className="showcase-content">
            <div className="showcase-text">
              <h2>Beautiful Certificate Templates</h2>
              <p>Choose from our professionally designed templates or upload your own custom design.</p>

              {/* Canva Link as Styled Button */}
              <a
                href="https://www.canva.com/certificates/templates/?msockid=30cdab8b0f526aa53cbbbf290ee06b2a" 
                target="_blank"
              ...
              >
                ...
                <svg width="15px" height="15px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M19.5 12L9.5 12" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </a>
            </div>
